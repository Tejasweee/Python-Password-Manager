        ...
        if int(num) in idnames:
            ...
            if value == 2:
                ...
                try:
                    ...
                    print('Password of ' + comp+ ' is:')
                    print(repass.decode())
                    print('-'*42)
                except Exception as e:
                    print(e)
                    print('This password was encrypted using different master password. Try entering correct master password')
...
def loop(secret_key, master_pwd):
    '''Loops continously generating a session of the entered master password, exits if value of 4 or greater than 4 provided.'''
    print('')
    print('_'*85)
...
if __name__ == "__main__":
    ...
    print('TO make sure that you entered the correct master password, you can retrieve one of previously saved password (if any) to avoid conflicts of different master passwords.')
